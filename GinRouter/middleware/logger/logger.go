...
func LoggerToFile() gin.HandlerFunc {
	...
	//写入文件
	src, err := os.OpenFile(logging.LogFileAbsolutePath, os.O_APPEND|os.O_WRONLY, os.ModeAppend)
	if err != nil {
		fmt.Println("err", err)
	}
	...
	return func(c *gin.Context) {
		...
		//aa["latency_time"] = latencyTime
		//aa["clientIP"] = clientIP
		//aa["reqMethod"] = reqMethod
		//aa["response_data"] = response_data.body.String()
		//
		//
		//fmt.Println("AAA = ", aa)
		//转换成json

		fmt.Println(logrus.Fields{
